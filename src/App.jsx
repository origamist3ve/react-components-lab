...
import WeatherForcast from "./components/WeatherForecast/WeatherForecast.jsx"
import './App.css'
        ...
        <>
            ...
            <section>
                {weatherForecasts.map((weather,index) => (
                    <WeatherForcast key={index} day={weather.day} img={weather.img} imgAlt={weather.imgAlt} conditions={weather.conditions} time={weather.time} />
                ))}
            </section>
        </>
